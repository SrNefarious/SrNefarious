...
def start(update, context):
    ...
    text = 'You may choose to search or apply for a requirement, check status add a familiy member, yourself show the gathered data or end the ' \
           'conversation. To abort, simply type /stop.'
    buttons = [[
        InlineKeyboardButton(text='Search for Requirements', callback_data=str(ADDING_MEMBER)),
        InlineKeyboardButton(text='Apply for Requirements ', callback_data=str(ADDING_SELF))
    ], [
    ...
    if context.user_data.get(START_OVER):
        ...
        update.message.reply_text('Hi, I\'m here to help you with following tasks.')
